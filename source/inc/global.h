...
//  config options 
//
#define  USE_WCID 1        /** automatic winusb driver load */
#define  USE_CDC  0        /** enable CDC code              */ 
#define  USE_TPI  1        /** enable TPI code              */
#define  USE_FCPY 1        /** fast copy using 0xA5 opcode  */
// usb configs
#define  EP0_SIZE       8  /** any of 8,16,32,64 works      */
#define  BULK_SIZE   0x40  /** allways 0x40 for USB FS      */
#define  CDC_BUFSIZE 0x80  /** max val to fit into CH551    */
...
#define USB_STATE_POWERED   0    /* maintaining the enum state -> not used */
