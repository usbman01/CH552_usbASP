...
/* USBASP capabilities */
#define USBASP_CAP_0_TPI    0x01 //todo move to globbal
...
#if (USBASP_CAP_0_TPI)               // switch on in global.h
...
/* LEDs are active low */
/*
#define ledRedOff()    P3_3 = 1
#define ledRedOn()     P3_3 = 0
#define ledGreenOff()  P3_4 = 1
#define ledGreenOn()   P3_4 = 0
*/
#endif /* USBASP_H_ */
